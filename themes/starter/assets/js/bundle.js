...
require('./components/nav-collapse');
...
(0, _retinajs2.default)();

/* Make jQuery available to October CMS */
window.$ = _jquery2.default;
window.jQuery = jQuery;

},{"./components/modal":6,"./components/nav-collapse":7,"jquery":3,"retinajs":4}],6:[function(require,module,exports){
'use strict';
...
},{"bootstrap/js/modal":1,"bootstrap/js/transition":2,"jquery":3}],7:[function(require,module,exports){
'use strict';
...
(0, _jquery2.default)('.js-nav-collapse').click(function (e) {
  e.preventDefault();
  var target = (0, _jquery2.default)(this).data('nav-collapse');
  (0, _jquery2.default)(target).toggleClass('nav-is-open');
});
...
Modernizr.on('touchevents', function (result) {
  ...
  if (result) {
    (0, _jquery2.default)('html').on('click', function () {
      (0, _jquery2.default)('.nav-section__item').removeClass('hover');
    });

    (0, _jquery2.default)('.nav-section__item').on('click', function (e) {
      if (!(0, _jquery2.default)(this).hasClass('hover') && (0, _jquery2.default)(this).has('.nav-dropdown').length > 0) {
        e.preventDefault();
        e.stopPropagation();
      }
...
},{"../vendors/modernizr":8,"jquery":3}],8:[function(require,module,exports){
"use strict";
